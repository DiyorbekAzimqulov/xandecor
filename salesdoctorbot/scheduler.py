...
def start():
    try:
        ...
        scheduler.add_job(
            daily_shipping_report,
            trigger=CronTrigger(hour=21, minute=0),  # Runs daily at 20:00 PM
        ...
        scheduler.add_job(
            daily_redistribute_report,
            trigger=CronTrigger(hour=21, minute=5),  # Runs daily at 20:05 PM
        ...
        scheduler.add_job(
            daily_forgotten_shipments,
            trigger=CronTrigger(hour=21, minute=10),  # Runs daily at 20:10 PM
